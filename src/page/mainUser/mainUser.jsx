    ...
    return ( 
        <div className="user">
            <div className="user_left">
               ...
               <p className="user_p">Lorem ipsum dolor sit amet, 
               consectetur adipiscing elit. Integer aliquet, orci
                in bibendum luctus, turpis ante pretium velit, eu 
                rutrum augue erat ac eros. Cras ultricies mattis convallis.</p>
            ...
            <div className="inner">
              ...
              <div className="btn-group me-2" onClick={clickButton} role="group" aria-label="First group">
                    <button type="button" id='left' className="btn btn-outline-secondary btn_rigth">
                        <img src={rigth} id='left' alt="rigth" />
                    </button>
                    <button type="button" id='1' className="btn btn-outline-secondary">1</button>
                    <button type="button" id='2' className="btn btn-outline-secondary">2</button>
                    <button type="button" id='3' className="btn btn-outline-secondary">3</button>
                    <button type="button" id='4' className="btn btn-outline-secondary">4</button>
                    <button type="button" id='5' className="btn btn-outline-secondary">5</button>
                    <button type="button" id='rigth' className="btn btn-outline-secondary btn_leftlar">
